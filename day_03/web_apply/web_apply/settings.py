"""
Django settings for web_apply project.
...
SECRET_KEY = '3(t#puw1!mg8q(qfwl^63e(5!si!52*yno@s25nh&p#7*%)z-e'
...
WSGI_APPLICATION = 'web_apply.wsgi.application'
